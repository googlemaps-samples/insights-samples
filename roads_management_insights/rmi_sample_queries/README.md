...
4.  **Before-and-After Impact Analysis**: Has the average travel time on routes passing through a recent construction zone improved?
    *   [View SQL](queries/ga/urban_planner/up2_impact_analysis.sql)
...
1.  **Metadata Inventory**: Zero-cost check of row count and storage size for RMI tables.
    *   [View SQL](queries/ga/bigquery_admin/bqa0_metadata_inventory.sql)
2.  **Scan Volume Monitoring**: Identify users or service accounts generating high scan volume.
    *   [View SQL](queries/ga/bigquery_admin/bqa1_scan_volume.sql)
3.  **Identify Derived Resources**: Audit tables or views derived from the core RMI dataset.
    *   [View SQL](queries/ga/bigquery_admin/bqa3_derived_resources.sql)
4.  **Data Complexity Audit**: Audit spatial complexity (vertex count) and metadata size of actual records.
    *   [View SQL](queries/ga/bigquery_admin/bqa6_data_complexity_audit.sql)
