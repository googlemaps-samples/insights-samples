...
This notebook demonstrates how to use the Gemini 3.5 Flash model with code execution to determine the lean angle of utility poles from images.
...
2.  **Image Analysis with Gemini**: For each image, it uses the Gemini 3.5 Flash model. The model is given a prompt that instructs it to use code execution to perform a series of image processing tasks.
