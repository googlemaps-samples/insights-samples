...
### Sample Assets with Multiple Observations

Run the `Sample_assets_with_multiple_observations.sql` query as follows:
...
bq query \
   ...
   < street_view_insights/cropped/queries/Sample_assets_with_multiple_observations.sql
```
